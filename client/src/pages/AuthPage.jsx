  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (isLogin) {
        ...
        const result = await signup(formData.name, formData.mobileNumber, formData.password)
        if (result.success) {
    ...
    <div className="min-h-screen bg-matka-grey-900 flex flex-col">
      ...
      <div className="bg-matka-green-800 shadow-lg px-6 py-4">
        <div className="flex items-center justify-center">
          <h1 className="text-2xl font-bold text-white">RAJ KALYAN MATKA</h1>
        </div>
      </div>
        ...
        <div className="max-w-md w-full">
          ...
          <div className="bg-gray-800 rounded-xl shadow-2xl border border-gray-700 p-8">
            ...
            <div className="mt-6 text-center">
              <button
                onClick={toggleMode}
                className="text-matka-green-400 hover:text-matka-green-300 font-medium transition-colors duration-200"
              >
