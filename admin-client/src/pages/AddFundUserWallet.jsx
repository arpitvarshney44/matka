...
const AddFundUserWallet = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true)
    try {
      const response = await axios.post(`${API_URL}/admin/add-fund-user-wallet`, {
        userId: selectedUser,
      ...
      if (response.data.success) {
        toast.success(`₹${amount} added to user wallet successfully`)
        setSelectedUser('')
        setAmount('')
        setSearchQuery('')
        setPhoneSearch('')
    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="bg-blue-600 shadow-lg px-6 py-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <h1 className="text-xl font-bold text-white">Add Fund (User Wallet)</h1>
          </div>
        </div>
      </div>
      ...
      <div className="p-6 max-w-2xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-6">
          <h2 className="text-lg font-semibold text-gray-800 mb-4">Add Balance In User Wallet</h2>
...
export default AddFundUserWallet